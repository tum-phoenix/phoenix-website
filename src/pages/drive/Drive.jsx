    ...
    <div className="driveContainer">
      ...
      <BG>
        ...
        <p>
          ...
          state-of-the-art algorithms to navigate our 1/10 scale vehicles in a miniature smart city
          environment. Our team is made up of talented and passionate students from the Technical
          University of Munich, who are committed to pushing the boundaries of what&rsquo;s possible
          in the world of autonomous driving and connectivity. With the support of Bosch Engineering
